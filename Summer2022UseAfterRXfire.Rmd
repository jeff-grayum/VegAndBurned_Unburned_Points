...
s22rx %>%
  ...
  labs(x = "Days since fire",
       y = "% of sampled bobwhite in burned units",
       title = "Use of burned areas following prescribed fire in 2022") +
  theme_bw()
...
s22_rx_uniq <- s22rx_sc1[!duplicated(s22rx_sc1), ]
```
...
#write_xlsx(model_comparison_sorted, "/Users/jeffgrayum/Downloads/model_comparison22.xlsx")
```
