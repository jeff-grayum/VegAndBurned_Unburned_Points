...
pib_hg <- predict(model5, newdata = hgdf, type = "response")
...
# Generate predictions
pib_hf <- predict(model5, newdata = hfdf, type = "response")

# Plotting
plot(hf_values, pib_hf, type = "l", 
     xlab = "Height of forbs", ylab = "Predicted % in burned areas",
     main = "Predicted % in burned areas vs height of forbs")
...
# Generate predictions
pib_hs <- predict(model5, newdata = hsdf, type = "response")

# Plotting
plot(hs_values, pib_hs, type = "l", 
     xlab = "Height of shrubs", ylab = "Predicted % in burned areas",
     main = "Predicted % in burned areas vs height of shrubs")
