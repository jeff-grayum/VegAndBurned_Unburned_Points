...
s22_rx_uniq <- s22rx_sc[!duplicated(s22rx_sc), ]
```
...
DSF_df <- data.frame(
 air_temp_max_c = rep(mean(s22_rx_uniq_temp_mod$air_temp_max_c), length(DSF_values)),
 DSF =  DSF_values
)

DSF_pred <- data.frame(predict(gmodel9, newdata = DSF_df, type = "response", se.fit = TRUE))
